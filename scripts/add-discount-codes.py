...
PRODUCTS = {
    ...
    'Havnby FlatCore Foam Mattress': {'code': 'AWD', 'slug': 'havnby-autolevel', 'buy_url': 'https://havnby.com/products/flatcore-hybrid-support-mattress-for-tesla-model-y?ref=discount'},
    'Havnby FlatCore Foam Mattress - Solo Edition': {'code': 'AWD', 'slug': 'havnby-solo', 'buy_url': 'https://havnby.com/products/flatcore-hybrid-support-mattress-for-tesla-model-y-solo-edition?ref=discount'},
    'Havnby CloudCore Foam Mattress': {'code': 'AWD', 'slug': 'havnby-cloudcore', 'buy_url': 'https://havnby.com/products/cloudcore-hybrid-support-mattress-for-tesla-model-s-3-x-y?ref=discount'},
    'NovaPads Air-Foam Pro': {'code': 'AWD', 'slug': 'tesery-novapads', 'buy_url': 'https://novapads.com/?ref=AWD'},
